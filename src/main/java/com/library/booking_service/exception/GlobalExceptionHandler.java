...
/**
 * Exception handler for Booking Service.
...
public class GlobalExceptionHandler extends com.library.common.exception.GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleResourceUnavailableException(ResourceUnavailableException ex) {
        logger.error("Resource unavailable: {}", ex.getMessage());
        ErrorResponse error = new ErrorResponse(
    ...
    public ResponseEntity<ErrorResponse> handleInvalidCheckInException(InvalidCheckInException ex) {
        logger.error("Invalid check-in: {}", ex.getMessage());
        ErrorResponse error = new ErrorResponse(
